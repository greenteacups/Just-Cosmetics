...
public class MooshroomPet extends EntityCow {

    public MooshroomPet(Location loc, Player player) {
        super(EntityTypes.MOOSHROOM, ((CraftWorld) loc.getWorld()).getHandle());
